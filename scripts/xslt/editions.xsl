	...
	<div class="flex flex-col">
			<div>
					<div class="flex flex-row my-4 transcript active">
							<div class="basis-12/12 text px-4 .yes-index">
									<div class="section">
											...
											<div class="sticky top-4 flex">
													<div class="my-4 bg-white rounded border border-gray-100 p-2">
														<div>
															<input class="p-2" type="checkbox" name="opt[]" value="separateWordSearch" checked="checked"/>Wörter einzeln suchen
														</div>
														<div>
															<input type="text" name="keyword" class="p-2 border border-gray-200 rounded" placeholder="Schlagwort eingeben..."/>
														</div>
													</div>
											</div>
											<div class="sticky top-28 flex">
