...
`.
 */
export type _wlblacklist = string;
 ...
 */
export type _cbgrfns = string;

/**
 * Function according to which the result is sorted.
 */
export type _csortfn = "t" | "m" | "3" | "l" | "s" | "p" | "r" | "f" | "d";

/**
 * Name of the subcorpus.
 */
export type _subcname = string;
 ...
 */
export type _onealpha = 1 | 0;

export type _max_keywords = number;

/**
 * The minimum n-gram length. Usually used with `ngrams_max_n` and `usengrams`.
 */
export type _ngrams_n = 2 | 3 | 4 | 5;
 ...
 */
export type _wlicase = 1 | 0;

/**
 * Sets the maximum frequency limit in the wordlist.
 */
export type _wlmaxfreq = number;
 ...
 */
export type _include_nonwords = 1 | 0;
 ...
 */
export type _attr_allpos = "kw" | "all";
 ...
 */
export type _viewmode = "sen" | "kwic";
 ...
 * @deprecated
 */
export type _wltype = "simple" | "struct_wordlist";
 ...
 *
 */
export type _ml1ctx = string;

/**
 * Additional optional attribute that should be included in the result.
 */
export type _wlstruct_attr2 = "word" | "lemma" | "tag" | "lempos";

/**
 * Additional optional attribute that should be included in the result.
 */
export type _wlstruct_attr3 = "word" | "lemma" | "tag" | "lempos";
 ...
 */
export type _attr = "lemma" | "word" | "TERM" | "WSCOLLOC";

export type _res = number;

export type _normalize = number;

export type _fc_lemword_window_type = string;

export type _fc_lemword_wsize = number;

export type _fc_lemword_type = string;

export type _fc_pos_wsize = number;

export type _fc_pos_type = string;

export type _fc_pos_window_type = number;

/**
 * The query type. You can send it directly or via the `json` parameter, the results are the same.
 */
export type _concordance_query_queryselector =
	| "iquery"
	| "cqlrow"
	| "lemmarow"
	| "charrow"
 ...
 */
export type _concordance_query_iquery = string;
 ...
 */
export type _errcorr_switch = "corr" | "err";
 ...
 */
export type _ml2ctx = string;

/**
 * Used to count the frequency of positional attributes [attributes](https://www.sketchengine.eu/my_keywords/positional-attribute/). Just like `ml1attr` but optional.
 */
export type _ml3attr = string;

/**
 * Position of the selected attribute in the concordance. Minus means left context (-1<0). Plus means right context (6>0). Just like ml1ctx but optional.
 */
export type _ml3ctx = string;

/**
 * Used to count the frequency of positional attributes [attributes](https://www.sketchengine.eu/my_keywords/positional-attribute/). Just like `ml1attr` but optional.
 */
export type _ml4attr = string;

/**
 * Position of the selected attribute in the concordance. Minus means left context (-1<0). Plus means right context (6>0). Just like ml1ctx but optional.
 */
export type _ml4ctx = string;

/**
 * Used to count the frequency of positional attributes [attributes](https://www.sketchengine.eu/my_keywords/positional-attribute/). Just like `ml1attr` but optional.
 */
export type _ml5attr = string;

/**
 * Position of the selected attribute in the concordance. Minus means left context (-1<0). Plus means right context (6>0). Just like ml1ctx but optional.
 */
export type _ml5ctx = string;

/**
 * Used to count the frequency of positional attributes [attributes](https://www.sketchengine.eu/my_keywords/positional-attribute/). Just like `ml1attr` but optional.
 */
export type _ml6attr = string;

/**
 * Position of the selected attribute in the concordance. Minus means left context (-1<0). Plus means right context (6>0). Just like ml1ctx but optional.
 */
export type _ml6ctx = string;

/**
 * Sets the minimum frequency of the item.
 */
export type _minfreq_extract_keywords = string;

/**
 * Sets the maximum frequency of the item.
 */
export type _maxfreq_extract_keywords = number;
 ...
 */
export type _struct = string;

/**
 * The name of subcorpus you want to rename.
 */
export type _subcorp_id = string;

/**
 * A new name for the subcorpus.
 */
export type _new_subcorp_name = string;
 ...
 * Corpus name. To query your own corpus (e.g. username john, corpus mycorpus), `use` value `user/john/mycorpus`.
 */
export type _corpname_freqdist = string;
